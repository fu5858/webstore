	...
	<section>
		<div class="jumbotron">
			...
			<div class="pull-right" style="padding-right:50px">
				<a href="?language=ko" >English</a>|<a href="?language=nl">Dutch</a>
			</div>	
			<div class="container">
				<h1>Products</h1>
				<p>Add products</p>
	...
	<section class="container">
		...
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<form:input id="manufacturer" path="manufacturer" class="form:input-large"/>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-10">
					<form:input id="category" path="category" class="form:input-large"/>
				</div>
			</div>
			<div class="form-group">
